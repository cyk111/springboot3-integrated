package com.cyk.springboot3.mutil.datasources.config;
...
@MapperScan(basePackages = "com.cyk.springboot3.mutil.datasources.mapper1",sqlSessionFactoryRef = "masterSqlSessionFactory")

public class MasterDataSourceConfig {

    // mapper.xml所在地址
    private static final String MAPPER_LOCATION = "classpath*:mybatis/mapper1/*.xml";
