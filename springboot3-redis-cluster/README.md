...
-v /data/redis/share/redis-node-1/conf/redis.conf:/etc/redis/redis.conf \
-v /data/redis/share/redis-node-1/log/redis.log:/data/redis/redis-log/redis.log \
redis:6.0.8 \
--cluster-enabled yes \
--appendonly yes \
--port 6381
...
-v /data/redis/share/redis-node-2/conf/redis.conf:/etc/redis/redis.conf \
-v /data/redis/share/redis-node-2/log/redis.log:/data/redis/redis-log/redis.log \
redis:6.0.8 \
--cluster-enabled yes \
--appendonly yes \
--port 6382
...
-v /data/redis/share/redis-node-3/conf/redis.conf:/etc/redis/redis.conf \
-v /data/redis/share/redis-node-3/log/redis.log:/data/redis/redis-log/redis.log \
redis:6.0.8 \
--cluster-enabled yes \
--appendonly yes \
--port 6383
...
-v /data/redis/share/redis-node-4/conf/redis.conf:/etc/redis/redis.conf \
-v /data/redis/share/redis-node-4/log/redis.log:/data/redis/redis-log/redis.log \
redis:6.0.8 \
--cluster-enabled yes \
--appendonly yes \
--port 6384
...
-v /data/redis/share/redis-node-5/conf/redis.conf:/etc/redis/redis.conf \
-v /data/redis/share/redis-node-5/log/redis.log:/data/redis/redis-log/redis.log \
redis:6.0.8 \
--cluster-enabled yes \
--appendonly yes \
--port 6385
...
-v /data/redis/share/redis-node-6/conf/redis.conf:/etc/redis/redis.conf \
-v /data/redis/share/redis-node-6/log/redis.log:/data/redis/redis-log/redis.log \
redis:6.0.8 \
--cluster-enabled yes \
--appendonly yes \
--port 6386
